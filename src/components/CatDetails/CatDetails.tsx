    ...
    <div className="w-full ms-5 mb-10">
      <div className="text-start ms-4 mt-5">
        <div className="flex items-center" style={{ color: '#25384D' }}>
          <Link to="/Deals">
            <img src="assets/icons/arrow_left.svg" className="mr-4" alt="" />
          </Link>
        ...
        <div
          className="mt-6 mb-10 text-start"
          style={{ color: '#25384D', fontWeight: '400', fontSize: '16px', lineHeight: '24px' }}
        >
          Take advantage of this limited-time offer for a comprehensive health insurance plan with enhanced benefits.
          This plan provides coverage for medical, hospitalization, and prescription drug expenses, ensuring you and
          your family have access to quality healthcare when you need it most. Enjoy the following:
          <br />
          <br />
          ...
          <ul className="ms-9 my-2" style={{ listStyleType: 'disc' }}>
            ...
            <li style={{ color: '#25384D' }}>
              Premiums may vary based on age, location, and specific coverage options.
            </li>
            <li style={{ color: '#25384D' }}>
