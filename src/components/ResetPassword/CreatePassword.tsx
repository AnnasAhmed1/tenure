        ...
        <form onSubmit={formik.handleSubmit}>
          <label className="block min-w-full desktop:py-4 phone:py-2">
            ...
            {formik.touched.password && formik.errors.password ? (
              <>
                <div className="invisible peer-invalid:visible text-danger-500 text-sm">{formik.errors.password}</div>
                <div className="container min-w-full center relative flex flex-col justify-center items-center mt-2 invisible peer-valid:text-primary-500 peer-invalid:visible text-danger-500 text-sm">
