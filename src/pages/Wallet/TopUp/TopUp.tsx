...
const TopUp = () => {
  ...
  return (
    <>
      ...
      <div className="w-full ms-5 mt-12">
        <div className="flex gap-3">
          <div
            className={`rounded-xl cursor-pointer  border-2 pl-2 py-2 ${active === 'card' && 'border-primary-400'}`}
            style={{ width: '110px' }}
          ...
          <div
            className={`rounded-xl cursor-pointer border-2 pl-2 py-2 ${active === 'bank' && 'border-primary-400'}`}
            style={{ width: '110px' }}
        ...
        {active === 'bank' && (
          <>
            ...
            <div className="w-full mt-10 flex gap-4 justify-between" style={{ width: '95%' }}>
              <div
                className={`border-4 w-3/12 rounded-lg flex items-center justify-center  ${
                  activeBank === 'Canada' ? ' bg-green-200 ' : ' '
                } `}
              >
                <img src={`assets/images/bankofcanada.png`} alt="" className=" m-auto " style={{ width: '50%' }} />{' '}
              </div>

              <div
                className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${
                  activeBank === 'TD' ? ' bg-green-200 ' : ' '
                } `}
              >
                <img src={`assets/images/td.png`} alt="" className=" m-auto " style={{ width: '50%' }} />{' '}
              </div>
              <div
                className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${
                  activeBank === 'Royal' ? ' bg-green-200 ' : ' '
                } `}
              >
                <img src={`assets/images/rbc.png`} alt="" className=" m-auto " style={{ width: '50%' }} />{' '}
              </div>
              <div
                className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${
                  activeBank === 'Nova' ? ' bg-green-200 ' : ' '
                } `}
              >
                <img src={`assets/images/scoti.png`} alt="" className=" m-auto " style={{ width: '50%' }} />{' '}
              </div>
              <div
                className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${
                  activeBank === 'Montreal' ? ' bg-green-200 ' : ' '
                } `}
              >
                <img src={`assets/images/m.png`} alt="" className=" m-auto " style={{ width: '50%' }} />{' '}
              </div>
            </div>
          </>
        )}
