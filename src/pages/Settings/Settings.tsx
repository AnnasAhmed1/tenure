      ...
      <div className='w-full h-min-screen ms-9 h-full '>
        ...
        <div className="flex h-full w-full">
          <div className='h-full mt-6' style={{ boxShadow: 'rgb(197 197 197 / 22%) 12px 3px 10px', width: "100%", minWidth: "250px", maxWidth: "330px" }}>
            ...
            } mb-2 cursor-pointer py-2 px-3 flex justify-between`} style={{ color: "#5A7894" }}><div className="flex justify-center flex-row "><img src="assets/icons/user.svg" className='mr-2' alt="" />Account Info </div><img src="assets/icons/chevron_right.svg"  alt="" style={{width: "17px"}} /></a>
