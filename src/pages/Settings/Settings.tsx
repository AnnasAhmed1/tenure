    ...
    <div className="w-full h-min-screen ms-9 h-full ">
      ...
      <div className="flex h-full w-full">
        <div
          ...
          style={{
            boxShadow: 'rgb(197 197 197 / 22%) 12px 3px 10px',
            width: '100%',
            minWidth: '250px',
            maxWidth: '330px',
          }}
        >
          <a
            onClick={accSett}
            className={`${
              selectedCategory === 'accountSetting'
                ? 'bg-yellow-400 text-white'
                : 'hover:bg-yellow-400 hover:text-white'
            } mb-2 cursor-pointer py-2 px-3 flex justify-between`}
            style={{ color: '#5A7894' }}
          >
            <div className="flex justify-center flex-row ">
              <img src="assets/icons/user.svg" className="mr-2" alt="" />
              Account Info{' '}
            </div>
            <img src="assets/icons/chevron_right.svg" alt="" style={{ width: '17px' }} />
          </a>
          <a
            onClick={passSett}
            className={`${
              selectedCategory === 'passwordSetting'
                ? 'bg-yellow-400 text-white'
                : 'hover:bg-yellow-400 hover:text-white'
            } mb-2 cursor-pointer py-2 px-3 flex justify-between`}
            style={{ color: '#5A7894' }}
          >
            <div className="flex justify-center flex-row ">
              <img src="assets/icons/password.svg" className="mr-2" alt="" />
              Change password{' '}
            </div>{' '}
            <img src="assets/icons/chevron_right.svg" alt="" style={{ width: '17px' }} />
          </a>
          <a
            className={`${
              selectedCategory === 'customerSupport'
                ? 'bg-yellow-400 text-white'
                : 'hover:bg-yellow-400 hover:text-white'
            } mb-2 cursor-pointer py-2 px-3 flex justify-between`}
            style={{ color: '#5A7894' }}
          >
            <div className="flex justify-center flex-row ">
              <img src="assets/icons/contact_support.svg" className="mr-2" alt="" />
              Contact support{' '}
            </div>
            <img src="assets/icons/chevron_right.svg" alt="" style={{ width: '17px' }} />
          </a>
        ...
        {accDivShown && (
          <div className="ml-10 mt-8 w-full" style={{ color: '#5A7894' }}>
            <div className="flex w-11/12 justify-between">
              <h4 className="text-xl text-black">Account Info</h4>
              <button
                onClick={EditInfo}
                className="flex  p-2 rounded-lg"
                style={{ border: '1px solid #38857b', color: '#38857b', fontWeight: '700' }}
              >
              ...
              <>
                ...
                <div className="flex mt-10 justify-between w-5/12 ">
                  ...
                  <div className="flex flex-col ml-8">
                    <h6 className="font-bold text-lg text-start whitespace-nowrap">No of Employees</h6>
              ...
              <form className="flex mt-12 justify-between w-5/6" onSubmit={formik.handleSubmit}>
                <div className="flex flex-col w-full text-start" style={{ color: '#25384D' }}>
                  ...
                  <Box sx={{ width: 1 }}>
                    <FormControl fullWidth>
                      ...
                      <Select
                        ...
                        style={{
                          border: formik.touched.companySize && formik.errors.companySize ? '1px solid red' : '',
                        }}
                      >
                        {companySize.map((e) => {
                  ...
                  <div className="flex justify-end mt-5">
                    <button
                      className="p-2 rounded-md cursor-pointer mx-2"
                      onClick={info}
        ...
        {passDivShown && (
          <div className="w-full text-start">
            <h1 className="w-11/12 m-auto">Change Password</h1>
            <div className="flex mt-12 justify-between w-full">
              <form
                className="flex flex-col w-11/12 m-auto text-start"
                style={{ color: '#25384D' }}
              ...
              >
                ...
                <button
                  ...
                  style={{ left: '97%', transform: 'translateY(-40px)' }}
