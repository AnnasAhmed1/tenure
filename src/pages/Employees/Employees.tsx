        ...
        <div>
          <ul className="flex ">
            <li className="list-none p-2 rounded-lg flex items-center  cursor-pointer" onClick={sendANotOp}>
              <img src="assets/icons/bell.svg" className="mr-2" alt="" />
              <h6>{SendANotification}</h6>
            </li>
            <li
              className="list-none mx-2 border-2 border-solid rounded-lg flex cursor-pointer items-center"
              style={{ borderColor: '#34897b' }}
              onClick={giftAllEmOp}
            >
              <img src="assets/icons/gift.svg" className="ms-1" width={'20px'} alt="" />
          ...
          >
            <Box sx={style}>
              <div className="flex justify-end">
                <img src="assets/icons/cross69.svg" className="cursor-pointer" onClick={giftAllEmCl} alt="" />
              </div>
              ...
              <form onSubmit={formik2.handleSubmit}>
                <div>
                  ...
                  <TextField
                    name="Details"
                    label="Enter Details"
                    className="w-full rounded-lg my-2 details-textfeild"
                    multiline
                    // cols={10}
                    rows={5}
          ...
          >
            <Box sx={style3}>
              <div className="flex justify-end">
                <img src="assets/icons/cross69.svg" className="cursor-pointer" onClick={addEmCl} alt="" />
              </div>
              <h3 className="text-center mt-6" style={{ color: '#25384D', fontWeight: '700' }}>
                AddAnEmployee
              </h3>
                  ...
                  <Form className="w-full" method="Post">
                    ...
                    >
                      <span className="contents">
                        Send Invite
                        &nbsp;<img src=assets/chevron_right.svg" style={{ filter: 'brightness(300%)' }} alt="right_arrow"></img>
                      </span>
                    </Button>
                  </div> */}
                  </Form>
              ...
              {/* <div className="mt-4 flex flex-col">
                ...
                <div className=" relative">
                  ...
                  />
                  <img src="assets/icons/search.svg" alt="" className="absolute bottom-4 right-2 cursor-pointer" />
                </div>
              </div>
              <div className="flex justify-end mt-3">
                <img src="assets/icons/add_1.svg" className="mx-2" />
